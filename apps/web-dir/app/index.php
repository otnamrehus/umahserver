...
//Application Title
define('APP_TITLE', ' Manajemen Data');
...
$auth_users = array(
    ...
    'guru' => '$2y$10$V9TaMCsh4aWQhgnsb6B5cuSqidWmVKO0T5lXqIPVLGMdowxQwogs6',
    'siswa' => '$2y$10$V9TaMCsh4aWQhgnsb6B5cuSqidWmVKO0T5lXqIPVLGMdowxQwogs6',
    'umum' => '$2y$10$V9TaMCsh4aWQhgnsb6B5cuSqidWmVKO0T5lXqIPVLGMdowxQwogs6'
);
                        ...
                        <div class="card fat <?php echo fm_get_theme(); ?>">
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="mb-3">
                                       <div class="brand">
                                            <svg version="1.0" xmlns="http://www.w3.org/2000/svg" M1008 width="100%" height="80px" viewBox="0 0 238.000000 140.000000" aria-label="Manajemen Data <br>SMKN 6 Kota Serang">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://blog.smknegeri6kotaserang.my.id" target="_blank" class="app-v-title"> Manajemen Data - ICT Center SMKN 6 Kota Serang <?php echo VERSION; ?></a></h3></p>
                        <p>Mail Us: <a href="mailto:smknegeri6kotaserang@gmail.com">ICT-Center[at]SMKN 6 Kota Serang</a> </p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
